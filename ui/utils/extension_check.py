    ...
    if is_flatpak():
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                # Automatically enable the extension after installation
                try:
                    ...
                    if enable_result.returncode == 0:
                        logger.info("Extension enabled successfully after installation")
                        ...
                        return True, "Extension installed successfully (manual enable may be required)"
                except Exception as e:
                    logger.warning(f"Extension installed but error during enable: {e}")
                    return True, "Extension installed successfully (manual enable may be required)"
            else:
    ...
    try:
        ...
        try:
            ...
            if success:
                ...
                logger.warning(f"Extension installed but failed to enable: {message}")
                return True, "Extension installed successfully (manual enable may be required)"
        except Exception as e:
            logger.warning(f"Extension installed but error during enable: {e}")
            return True, "Extension installed successfully (manual enable may be required)"
