...
class ExtensionSettingsStore:
    """
    Lightweight wrapper for controlling the GNOME extension's monitoring state.
    This class doesn't manage settings, only provides methods to start/stop
    clipboard monitoring and enable/disable keybindings.
    """
